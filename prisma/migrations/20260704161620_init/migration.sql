...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('PROMPTPAY', 'STRIPE', 'OMISE', 'BANK_TRANSFER');

-- CreateEnum
CREATE TYPE "ShippingCarrier" AS ENUM ('FLASH_EXPRESS', 'KERRY', 'THAILAND_POST', 'JT_EXPRESS');
...
CREATE TABLE "Order" (
    ...
    "shipSubdistrict" TEXT NOT NULL,
    "shipDistrict" TEXT NOT NULL,
    "shipProvince" TEXT NOT NULL,
    "shipZipcode" TEXT NOT NULL,
